...
<!-- Mirrored from themesdesign.in/dason-django/layouts/default/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2024 22:11:21 GMT -->
                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    @endif
                                    <form class="mt-4 pt-2" action="{{route('login.create')}}">
                                        @csrf
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input type="text" class="form-control" id="input-email" name="email" placeholder="Enter User Name">
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Don't have an account ? <a href="{{route('register.page')}}"
