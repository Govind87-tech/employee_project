...
<!-- Mirrored from themesdesign.in/dason-django/layouts/default/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2024 22:11:21 GMT -->
...
<body data-topbar="dark">
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{asset('public/assets/images/logo-sm.svg')}}" alt="" height="28"> <span class="logo-txt">Dason</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    @endif
                                    <form class="needs-validation mt-4 pt-2" novalidate action="{{route('register.create')}}" method="post">
                                        @csrf
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Already have an account ? <a href="{{route('login.page')}}"
                                    ...
                                    <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-indicators auth-carousel carousel-indicators-rounded justify-content-center mb-0">
                                            <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                                <img src="{{asset('public/assets/images/users/avatar-1.jpg')}}" class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                            </button>
                                            <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                                <img src="{{asset('public/assets/images/users/avatar-2.jpg')}}" class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                            </button>
                                            <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                                <img src="{{asset('public/assets/images/users/avatar-3.jpg')}}" class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                            </button>
                                        </div>
    ...
    <!-- validation init -->
    <script src="{{asset('public/assets/js/pages/validation.init.js')}}"></script>

    <script src="{{asset('public/assets/js/pages/feather-icon.init.js')}}"></script>
